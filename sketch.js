...
line (bobObject1.body.position.x , bobObject1.body.position.y , roof.body.position.x-80 , roof.body.position.y );
line (bobObject2.body.position.x , bobObject2.body.position.y , roof.body.position.x-40 , roof.body.position.y );
line (bobObject3.body.position.x , bobObject3.body.position.y , roof.body.position.x , roof.body.position.y );
line (bobObject4.body.position.x , bobObject4.body.position.y , roof.body.position.x+40 , roof.body.position.y );
line (bobObject5.body.position.x , bobObject5.body.position.y , roof.body.position.x+80 , roof.body.position.y );
